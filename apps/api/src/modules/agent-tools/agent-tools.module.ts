...
@Module({
  ...
  providers: [ToolRegistryService, EchoReportTool, ResolveChapterTool, CollectChapterContextTool, WriteChapterTool, PostProcessChapterTool, PolishChapterTool, FactValidationTool, AutoRepairChapterTool, ExtractChapterFactsTool, RebuildMemoryTool, ReviewMemoryTool, InspectProjectContextTool, GenerateOutlinePreviewTool, ValidateOutlineTool, PersistOutlineTool, AnalyzeSourceTextTool, BuildImportPreviewTool, ValidateImportedAssetsTool, PersistProjectAssetsTool, ReportResultTool],
