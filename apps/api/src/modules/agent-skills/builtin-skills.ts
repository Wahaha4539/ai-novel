...
export const BUILTIN_SKILLS: AgentSkill[] = [
  {
    ...
    taskTypes: ['general', 'chapter_write', 'multi_chapter_write', 'chapter_polish', 'chapter_revision', 'character_consistency_check', 'worldbuilding_expand', 'story_bible_expand', 'scene_card_planning', 'plot_consistency_check', 'continuity_check', 'ai_quality_review', 'memory_review', 'project_import_preview', 'outline_design', 'guided_step_consultation', 'guided_step_generate', 'guided_step_finalize'],
    description: 'Agent-Centric MVP 默认技能，用于先跑通结构化计划、审批、创作引导上下文和工具执行闭环。',
    defaultTools: ['resolve_chapter', 'resolve_character', 'collect_chapter_context', 'collect_task_context', 'character_consistency_check', 'plot_consistency_check', 'generate_continuity_preview', 'validate_continuity_changes', 'persist_continuity_changes', 'ai_quality_review', 'inspect_project_context', 'generate_worldbuilding_preview', 'validate_worldbuilding', 'persist_worldbuilding', 'generate_story_bible_preview', 'validate_story_bible', 'persist_story_bible', 'list_scene_cards', 'generate_scene_cards_preview', 'validate_scene_cards', 'persist_scene_cards', 'update_scene_card', 'write_chapter', 'write_chapter_series', 'polish_chapter', 'fact_validation', 'echo_report', 'report_result'],
