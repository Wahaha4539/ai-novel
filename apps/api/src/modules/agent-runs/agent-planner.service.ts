    ...
    const messages = [
      {
        ...
        content: [
          ...
          '用户要求“章节细纲 / 第 N 卷章节细纲 / 章节规划”，且没有明确说重写卷纲、重新拆成 N 章、改变章数或从头规划时，选择 outline_design，并优先承接 inspect_project_context 中已有 Volume.narrativePlan/storyUnitPlan，直接编排 inspect_project_context -> generate_chapter_outline_preview（每章一个步骤）-> merge_chapter_outline_previews -> persist_outline；不要追加末尾 validate_outline，不要重新生成卷大纲或单元故事。',
