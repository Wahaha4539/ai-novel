...
export const outlineToolBundles: ToolBundleDefinition[] = [
  ...
  },
  {
    ...
    optionalToolNames: ['generate_volume_outline_preview', 'persist_volume_outline', 'persist_volume_character_candidates'],
    deniedToolNames: ['segment_chapter_outline_batches', 'generate_chapter_outline_batch_preview', 'merge_chapter_outline_batch_previews', 'generate_chapter_outline_preview', 'merge_chapter_outline_previews', 'persist_outline', 'write_chapter', 'write_chapter_series'],
    plannerGuidance: [
      'Generate or rewrite independent storyUnitPlan for a volume.',
      'When the user explicitly asks for both a volume outline and story units, first generate_volume_outline_preview, persist_volume_outline after approval, then generate_story_units_preview with volumeOutline from the generated volume and persist_story_units.',
      'If the user only asks for story units, do not rewrite the volume outline.',
